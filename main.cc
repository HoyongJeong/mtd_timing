////////////////////////////////////////////////////////////////////////////////
//   main.cc for mtd_timing
//
//   This is main function of the simulation program.
//
//                        - Nov 10th 2025 Hoyong Jeong (hoyong5419@korea.ac.kr)
////////////////////////////////////////////////////////////////////////////////
...
void PrintHelp()
{
	std::cout << "usage: mtd_timng [-b] [-g] [-m macrofile]" << std::endl;
	std::cout << std::endl;
	std::cout << "Examples:" << std::endl;
	std::cout << "  mtd_timing -b -m myRun.mac  # Run in batch mode with macro and config." << std::endl;
	std::cout << "  mtd_timing -g               # Run in graphical mode."                   << std::endl;
	std::cout << std::endl;
